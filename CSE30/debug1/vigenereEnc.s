/*
 * Filename: vigenereEnc.s
 * Author: Bugs Bunny
 * UserId: cs30x420
 * Description: Defines the vigenere encryption function.
 * Date: 4/20/18
 ...
 */
	...
	.align	2
/*
 * Function Name: vigenereEnc()
 * Function Prototype: void vigenereEnc( byteArray_t * out,
 *                                       byteArray_t * key,
 *                                       byteArray_t * in );
 * Description: Encrypts plaintext into ciphertext, using a given key to
 ...
 *             key - Key used to determine shifts to encrypt plaintext.
...
loop:
	...
	add	r0, r0, r1			@ r0 = in byte + key byte
	...
	ldr	r2, [fp, I_OFFSET]		@ r2 = i
	strb	r0, [r3, r2]			@ store r0 into in->bytes[i]
