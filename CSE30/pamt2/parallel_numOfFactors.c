/* Filename: parallel_numOfFactors.c
 * Author: Zhuoer Wen 
 * Userid: cs30xgz
 * Description: parallel version of numofFactors to get num of factors
 * Date: May/31/2018
 */

#define TWO 2
/*
 * Function name: parallel_numOfFactors()
 *
 * Function prototype: long long parallel_numOfFactors( long long n,
 *                                                      long long lo,
 *                                                      long long hi );
 *
